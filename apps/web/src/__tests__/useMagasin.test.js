...
function setUser(magasin_ids, magasin_noms = []) {
    mockUseAuth.mockImplementation((selector) => selector({ user: { magasin_ids, magasin_noms, role: 'commercial' } }));
}
function setAdmin() {
    mockUseAuth.mockImplementation((selector) => selector({ user: { magasin_ids: [], magasin_noms: [], role: 'admin' } }));
}
function setNoUser() {
    mockUseAuth.mockImplementation((selector) => selector({ user: null }));
}
beforeEach(() => {
